...
We will be mainly focusing on the POSIX C library which extends ISO.
Now to get the elephant out of the room, the Linux kernel fails to be POSIX compliant.
