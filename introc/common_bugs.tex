...
In the above code it simply changes the dest pointer to point to the source string.
...
A double free error is when a program accidentally attempts to free the same allocation twice.
...
Automatic variables hold garbage or the bit pattern that happened to be in memory or register.
