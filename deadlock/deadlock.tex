...
\begin{proof} Dijkstra's Solution Doesn't Deadlock
	...
	If the philosopher doesn't obtain that first lock, then we have a reduction to Stallings' proof above because we now have $n-1$ philosophers vying for $n$ resources.
